...
export class DenoPlatformDataView {
  ...
  public getF32(byteOffset: number): f32 {
    return this._view.getFloat32(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN) as f32;
  }

  public getF64(byteOffset: number): f64 {
    return this._view.getFloat64(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN) as f64;
  }
  ...
  public getI16(byteOffset: number): i16 {
    return this._view.getInt16(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN) as i16;
  }

  public getI32(byteOffset: number): i32 {
    return this._view.getInt32(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN) as i32;
  }

  public getI64(byteOffset: number): i64 {
    return this._view.getBigInt64(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN) as i64;
  }
  ...
  public getPointer<T>(byteOffset: number): Pointer<T> {
    ...
    return denoFromPlatformPointer(
      Deno.UnsafePointer.create(
        this._view.getBigUint64(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN),
  ...
  public getU16(byteOffset: number): u16 {
    return this._view.getUint16(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN) as u16;
  }

  public getU32(byteOffset: number): u32 {
    return this._view.getUint32(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN) as u32;
  }

  public getU64(byteOffset: number): u64 {
    return this._view.getBigUint64(this.byteOffset + byteOffset, DenoPlatformDataView.LITTLE_ENDIAN) as u64;
  }

  public setF32(byteOffset: number, value: f32): void {
    DenoPlatformDataView.ensureViewIsDataView(this._view);
    this._view.setFloat32(this.byteOffset + byteOffset, value, DenoPlatformDataView.LITTLE_ENDIAN);
  }

  public setF64(byteOffset: number, value: f64): void {
    DenoPlatformDataView.ensureViewIsDataView(this._view);
    this._view.setFloat64(this.byteOffset + byteOffset, value, DenoPlatformDataView.LITTLE_ENDIAN);
  }
  ...
  public setI16(byteOffset: number, value: i16): void {
    DenoPlatformDataView.ensureViewIsDataView(this._view);
    this._view.setInt16(this.byteOffset + byteOffset, value, DenoPlatformDataView.LITTLE_ENDIAN);
  }

  public setI32(byteOffset: number, value: i32): void {
    DenoPlatformDataView.ensureViewIsDataView(this._view);
    this._view.setInt32(this.byteOffset + byteOffset, value, DenoPlatformDataView.LITTLE_ENDIAN);
  }

  public setI64(byteOffset: number, value: i64): void {
    DenoPlatformDataView.ensureViewIsDataView(this._view);
    this._view.setBigInt64(this.byteOffset + byteOffset, value, DenoPlatformDataView.LITTLE_ENDIAN);
  }
  ...
  public setU16(byteOffset: number, value: u16): void {
    DenoPlatformDataView.ensureViewIsDataView(this._view);
    this._view.setUint16(this.byteOffset + byteOffset, value, DenoPlatformDataView.LITTLE_ENDIAN);
  }

  public setU32(byteOffset: number, value: u32): void {
    DenoPlatformDataView.ensureViewIsDataView(this._view);
    this._view.setUint32(this.byteOffset + byteOffset, value, DenoPlatformDataView.LITTLE_ENDIAN);
  }

  public setU64(byteOffset: number, value: u64): void {
    DenoPlatformDataView.ensureViewIsDataView(this._view);
    this._view.setBigUint64(this.byteOffset + byteOffset, value, DenoPlatformDataView.LITTLE_ENDIAN);
  }
}
